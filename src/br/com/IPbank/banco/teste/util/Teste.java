...
public class Teste {
	...
	public static void main(String[] args) {
		...
		lista.sort((c1, c2) -> Integer.compare(c1.getNumero(), c2.getNumero())); // classe que faz comparação entre 2
																					// numeros

		Comparator<Conta> comp = (Conta c1, Conta c2) -> { // classe que tbm faz comparação, porém mais explicito
															// comparando os nomes com return
